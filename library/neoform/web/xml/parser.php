    ...
    class web_xml_parser {
        ...
        */
        private function endElement($parser, $tagName) {
            ...
            $this->currentTag = isset($this->insideItem[count($this->insideItem)-1]) ? $this->insideItem[count($this->insideItem)-1] : array();
        }
        ...
        */
        ...
        private function getParentTag() {
            return isset($this->insideItem[count($this->insideItem) - 2]) ? $this->insideItem[count($this->insideItem) - 2] : array();
        }
