    ...
    class locale_instance {
        ...
        public function set_namespace($namespace_name) {
            ...
            if (! isset($this->namespace_ids[$namespace_name])) {
                $this->namespace_ids[$namespace_name] = (int) current(entity_dao::get('locale_namespace')->by_name(
                    $namespace_name
                ));
            }
        ...
        public function translate($key, $namespace_name=null) {
            ...
            if ($namespace_name === null) {
                ...
                if (isset($this->namespace_ids[$namespace_name])) {
                    ...
                    $namespace_id = $this->namespace_ids[$namespace_name] = (int) current(entity_dao::get('locale_namespace')->by_name(
                        $namespace_name
                    ));
                }
