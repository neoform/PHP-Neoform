<?php
    ...
    namespace Neoform\Entity\Link\Test;
    ...
    class Dao extends \Neoform\Entity\Link\Dao {
        ...
        const NAME        = 'test user site link';
        const TABLE       = 'test_site';
        const ENTITY_NAME = 'Neoform\User\Site';
        const CACHE_KEY   = 'test_user_site';
        ...
        public function insert(array $info, $replace) {
            ...
            return parent::_insert($info, $replace);
        }
        ...
        public function insertMulti(array $infos, $replace) {
            ...
            return parent::_insertMulti($infos, $replace);
        }
