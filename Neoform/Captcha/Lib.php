<?php
    ...
    class Lib {
         ...
         */
        public static function session_make(Neoform\Request\Model $request) {
            $request->getSession()->getFlash()->set('captcha', 1, 60);
        }
         ...
         * @return bool
         */
        public static function session_validate(Neoform\Request\Model $request) {

            if ($return = (bool) $request->getSession()->getFlash()->get('captcha')) {
                $request->getSession()->getFlash()->del('captcha');
            }
