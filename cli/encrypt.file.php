...
<?php
    ...
    class encrypt_file extends neoform\cli_model {
        ...
        public function init() {
            ...
            if (substr($filepath, -6) === '.crypt') {
                $decrypted_string = neoform\encrypt_lib::decrypt($password, $file_contents);
                ...
                $encrypted_string = neoform\encrypt_lib::encrypt($password, $file_contents);
                if ($encrypted_string) {
